        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                <img class="rounded-circle header-profile-user"
                    src="<?php echo e(Auth::user()->foto ? asset('img/' . Auth::user()->foto) : asset('assets/images/profile.png')); ?>"
                    alt="Header Avatar">
            </button>
            <div class="dropdown-menu dropdown-menu-end">
                <a class="dropdown-item" href="<?php echo e(route('pengguna')); ?>">
...
<?php /**PATH D:\Sistem-Personal\Catatan-keuangan-nilfia\resources\views/layout/navbar.blade.php ENDPATH**/ ?>